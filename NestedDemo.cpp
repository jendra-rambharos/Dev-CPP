...
//              Continue to accululate the
//              sum of these bumbers until the user
...
int main(int nNumberofArgs, char* pszArgs[])
{
    ...
    do
    {
        ...
        // if the accumulated sequence is not zero
    ...
    // wait until user is ready to terminate program
    system("PAUSE");
    return 0;
}
